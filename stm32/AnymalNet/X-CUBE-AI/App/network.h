...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "anymal"
...
#define AI_NETWORK_IN_1_CHANNEL     (48)
#define AI_NETWORK_IN_1_SIZE        (48)
#define AI_NETWORK_IN_1_SIZE_BYTES  (192)
...
#define AI_NETWORK_OUT_2_CHANNEL     (12)
#define AI_NETWORK_OUT_2_SIZE        (12)
#define AI_NETWORK_OUT_2_SIZE_BYTES  (48)
