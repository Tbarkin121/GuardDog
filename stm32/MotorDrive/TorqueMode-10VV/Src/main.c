...
#include <stdint.h>
#include "DRV8323/drv8323.h"
#include "AS5147U/as5147u.h"
...
int main(void)
{
  ...
  {
	  // If the opamp gain isn't set we can not read motor current correctly...
	  Error_Handler();
  }
  ...
  volatile FaultStatus drv8323_fault_status;
  while (1)
  {
