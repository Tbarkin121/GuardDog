...
#define PID_TORQUE_KP_DEFAULT         3500
#define PID_TORQUE_KI_DEFAULT         1102
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           3500
#define PID_FLUX_KI_DEFAULT           1102
...
#define PID_SPEED_KP_DEFAULT          2731/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
/* Phase 2 */
#define PHASE2_DURATION                1982 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (991*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A           5
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (991*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A           5
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (991*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A           5
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (991*SPEED_UNIT/U_RPM)
...
#define OBS_MINIMUM_SPEED_RPM          892
