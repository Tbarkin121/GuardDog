/**
  ******************************************************************************
  * @file    g0xx_bemf_ADC_OS_fdbk.h
  * @author  Motor Control SDK Team, ST Microelectronics
  * @brief   This file contains all definitions and functions prototypes for the
  *          multiple sensorless Bemf acquisition with ADC component of the Motor Control SDK.
  ******************************************************************************
  * @attention
  *
...
typedef struct
{
  ...
  uint32_t TIM_ADC_Trigger_Channel;
...
typedef struct
{
  ...
  uint16_t ADC1_DMA_converted[5]; /* Buffer used for DMA data transfer after the ADC conversion */
  uint16_t TIM1_pulses[5]; /* Buffer used for DMA data transfer after the ADC conversion */
  ...
  uint32_t ZC_Counter_Last;  /* Last low frequency timer counter value at zero crossing */
  uint32_t ZC_Counter_On_Last;  /* Last low frequency timer counter value at zero crossing sensed with pwm on*/
