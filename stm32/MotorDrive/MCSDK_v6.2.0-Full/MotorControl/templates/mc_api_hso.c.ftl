...
{
	return MCI_StartWithPolarizationMotor( pMCI[M1] );
}
...
{
	return( MCI_StartOffsetsCalibrationMotor( pMCI[M1] ) );
}
...
/**
  ...
  *        transition
  */
MC_RetStatus_t MC_SetRsDCEstimationEnableMotor1(void)
{
  return MCI_SetRsDCEstimationEnable(pMCI[M1]);
}
...
/**
  ...
  * @retval returns #MC_SUCCESS if successfully executed, or an error code otherwise.
  */
MC_RetStatus_t MC_EnablePulseMotor1(void)
{
  return MCI_EnablePulse(pMCI[M1]);
}
