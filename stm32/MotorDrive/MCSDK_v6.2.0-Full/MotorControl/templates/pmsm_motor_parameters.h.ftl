...
#define MOTOR_RS_SKINFACTOR     (float_t)(${MC.MOTOR_RS_SKINFACTOR})  /*!< @brief factor to compensate motor skin effect. */
#define MOTOR_MASS_COPPER_KG    (float_t)(${MC.MOTOR_MASS_COPPER_KG}) /*!< @brief This is the total copper mass of the windings. */
#define MOTOR_COOLINGTAU_S      (float_t)(${MC.MOTOR_COOLINGTAU_S})  /*!< @brief Thermal time constant of copper */
...
#define ID_DEMAG_A              (int16_t)${MC.M1_ID_DEMAG} /*!< Demagnetization current */
