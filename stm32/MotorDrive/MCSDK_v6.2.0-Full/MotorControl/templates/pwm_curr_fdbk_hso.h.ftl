...
struct PWMC_Handle
{
  ...
  PWMC_Generic_Cb_t
  pFctSwitchOffPwm;                    /*!< @brief pointer on the function the component instance uses to switch PWM off */
  PWMC_Generic_Cb_t
  pFctSwitchOnPwm;                     /*!< @brief pointer on the function the component instance uses to switch PWM on */
  PWMC_Generic_Cb_t
  pFctCurrReadingCalib;                /*!< @brief pointer on the function the component instance uses to calibrate the current reading ADC(s) */
  PWMC_TurnOnLowSides_Cb_t
  pFctTurnOnLowSides;                  /*!< @brief pointer on the function the component instance uses to turn low sides on */
  PWMC_SetSampPointSectX_Cb_t
  pFctSetADCSampPointSectX;  /*!< @brief pointer on the function the component instance uses to set the ADC sampling point  */
  PWMC_SetOcpRefVolt_Cb_t
  pFctOCPSetReferenceVoltage;    /*!< @brief pointer on the function the component instance uses to set the over current reference voltage */
  /** @} */
  ...
  bool TurnOnLowSidesAction;                            /*!< @brief true if TurnOnLowSides action is active,
                                                              false otherwise. */
