...
typedef struct
{
  ...
  BusVoltageSensor_Handle_t *pVBus;       /*!< @brief Bus voltage snesor handler */
...
MC_RetStatus_t MCI_StartMotor( MCI_Handle_t * pHandle );
MC_RetStatus_t MCI_StartWithPolarizationMotor( MCI_Handle_t * pHandle );
MC_RetStatus_t MCI_StartOffsetMeasurments(MCI_Handle_t *pHandle);
MC_RetStatus_t MCI_StopMotor( MCI_Handle_t * pHandle );
