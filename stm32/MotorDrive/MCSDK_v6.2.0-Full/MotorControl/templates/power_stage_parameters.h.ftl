...
#define VOLTAGE_FILTER_POLE_RPS		(${MC.M1_VOLTAGE_FILTER_POLE_RPS}) /*!< @brief  Time constant of the hardware RC filter applied to the phase voltage */ 
#define M1_PHASE_VOLTAGE_PARTITIONING_FACTOR (${MC.M1_PHASE_VOLTAGE_PARTITIONING_FACTOR}) /*!< It expresses how 
                                                       ...
                                                       before being converted into 
                                                       digital value */
#define BOARD_LIMIT_REGEN_HIGH		(float_t)(${MC.M1_BOARD_LIMIT_REGEN_HIGH}) /*!< @brief Bus voltage upper limit for regenerative current control. */
#define BOARD_LIMIT_REGEN_LOW		(float_t)(${MC.M1_BOARD_LIMIT_REGEN_LOW}) /*!< @brief  Bus voltage lower limit for regenerative current control. */
#define BOARD_LIMIT_ACCEL_HIGH		(float_t)(${MC.M1_BOARD_LIMIT_ACCEL_HIGH}) /*!< @brief DC bus voltage threshold above which maximum current is allowed */
#define BOARD_LIMIT_ACCEL_LOW		(float_t)(${MC.M1_BOARD_LIMIT_ACCEL_LOW}) /*!< @brief DC bus voltage threshold under which current needs to be limited */                                                  
