...
{
  int16_t returnValue;
  returnValue = (SPD_GetAvrgMecSpeedUnit(${SPD_AUX_M1}) * U_RPM) / SPEED_UNIT;
...
{
  return (((float_t)SPD_GetElAngle(${SPD_AUX_M1})) / S16ToRAD);
}
</#if>
...
{
  return ((float_t)(SPD_GetAvrgMecSpeedUnit(${SPD_AUX_M2}) * U_RPM) / SPEED_UNIT);
}
...
{
  return ((float_t)((SPD_GetElAngle(${SPD_AUX_M2})) / S16ToRAD));
}
</#if>
