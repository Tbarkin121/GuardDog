...
class Buffer():
    def __init__(self, num_envs, buf_horizon, num_actions, num_states, gamma):
    ...
    def get_SARS_minibatch(self, num_samples):
        ...
        return self.s1[env_ids, ...], self.a[env_ids, ...], self.rewards_to_go[env_ids, ...], self.s2[env_ids, ...], self.d[env_ids, ...], self.log_probs[env_ids, ...], self.returns[env_ids, ...]
