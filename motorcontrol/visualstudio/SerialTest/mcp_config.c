...
static uint8_t __declspec(align(4)) MCPSyncTxBuff[MCP_TX_SYNCBUFFER_SIZE]; //cstat !MISRAC2012-Rule-1.4_a
static uint8_t __declspec(align(4)) MCPSyncRXBuff[MCP_RX_SYNCBUFFER_SIZE]; //cstat !MISRAC2012-Rule-1.4_a

/* Asynchronous buffer dedicated to UART_A */
static uint8_t __declspec(align(4)) MCPAsyncBuffUARTA_A[MCP_TX_ASYNCBUFFER_SIZE_A]; //cstat !MISRAC2012-Rule-1.4_a
static uint8_t __declspec(align(4)) MCPAsyncBuffUARTA_B[MCP_TX_ASYNCBUFFER_SIZE_A]; //cstat !MISRAC2012-Rule-1.4_a
